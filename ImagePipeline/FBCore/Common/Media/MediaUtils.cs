...
namespace FBCore.Common.Media
{
    ...
    public class MediaUtils
    {
        ...
        /// </summary>
        public static readonly IDictionary<string, string> GENERAL_ALLOWED_MIME_TYPES =
        ...
        /// <summary>
        /// Additional mime types that we know to be a particular media type but which may 
        /// not be supported natively on the device.
        /// </summary>
        public static readonly IDictionary<string, string> ADDITIONAL_ALLOWED_MIME_TYPES = 
            new Dictionary<string, string>()
            {
        ...
        {
            return ADDITIONAL_ALLOWED_MIME_TYPES.Values.Contains(mimeType);
        }
