...
namespace Cache.Common
{
    ...
    ///
    /// <para /> All values may be null depending on the kind of event. See the docs for each method to see
    ...
    public interface ICacheEvent
    {
        ...
        ///
        /// <para /> This should be present for all events other than eviction.
        /// </summary>
        ...
        ///
        /// <para /> This is present in cache hit, write success, read and write exceptions and evictions.
        ///
        /// <para /> It may also be present in cache miss events if an ID was found in the cache's index but the
        ...
        ///
        /// <para /> This is present in eviction events where the eviction is due to the need to trim for size.
        /// </summary>
        long CacheLimit { get; }
