...
namespace ImagePipeline.Core
{
    ...
    ///
    /// <para />A very basic implementation would supply a single thread pool for all four operations.
    /// It is recommended that <see cref="ForLocalStorageRead"/> and <see cref="ForLocalStorageWrite"/> at least
    /// be different, as their threads will be I/O-bound, rather than CPU-bound as the others are.
    ///
    /// <para />Implementations should return singleton objects from these methods.
    ///
    /// </summary>
