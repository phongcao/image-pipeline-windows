namespace ImagePipeline.Cache
{
    ...
    public class MemoryCacheParams
    {
        ...
        /// <param name="maxCacheEntries">The maximum number of items that can live in the cache.</param>
        /// <param name="maxEvictionQueueSize">The eviction queue is an area of memory that stores items ready</param>
        ///                             for eviction but have not yet been deleted. This is the maximum
        ///                             size of that queue in bytes.
        /// <param name="maxEvictionQueueEntries">The maximum number of entries in the eviction queue.</param>
        /// <param name="maxCacheEntrySize">The maximum size of a single cache entry.</param>
        /// </summary>
