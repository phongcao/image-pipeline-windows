namespace ImagePipeline.Image
{
    ...
    public interface IQualityInfo
    {
        ...
        /// <para />When fetching image progressively, the few first results can
        /// be of really poor quality, but eventually, they get really close to
        /// original image, and we mark those as good-enough.
        /// </summary>
