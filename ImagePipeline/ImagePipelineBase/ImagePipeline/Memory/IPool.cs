...
namespace ImagePipeline.Memory
{
    ...
    /// <see cref="Get(int)"/> - returns a value of size that's the same or larger than the requested size
    ...
    /// calls to <see cref="IMemoryTrimmable.Trim(double)"/>. Some percent (perhaps all) of the
