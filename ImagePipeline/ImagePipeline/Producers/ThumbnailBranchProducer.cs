...
namespace ImagePipeline.Producers
{
    ...
    ///
    /// <para />The producer will try to get a result from each producer only if there is a 
    /// good chance of it being able to produce a sufficient result.
    ///
    /// <para /> If no underlying producer can provide a suitable result, null result is 
