namespace ImagePipeline.Producers
{
    ...
    ///
    /// <para />This producer can be used to terminate a sequence, e.g. for a bitmap cache 
    /// get only sequence, just use BitmapMemoryCacheGetProducer followed by NullProducer.
    /// </summary>
