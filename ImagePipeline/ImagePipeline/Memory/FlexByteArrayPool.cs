...
namespace ImagePipeline.Memory
{
    ...
    ///
    /// <para />The length of each bucket's free list is capped at
    /// the number of threads using the pool.
    /// <para />The free list of each bucket uses
    /// <see cref="OOMSoftReference{T}"/>s.
    /// </summary>
    public class FlexByteArrayPool
    {
        ...
        /// <summary>
        /// Gets the memory stats regarding buckets used, memory caps,
        /// reused values.
        /// </summary>
        /// <returns>
        /// The memory stats regarding buckets used, memory caps,
        /// reused values.
        /// </returns>
