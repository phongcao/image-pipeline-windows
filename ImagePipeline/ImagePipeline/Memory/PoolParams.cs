...
namespace ImagePipeline.Memory
{
    ...
    /// allocations will start failing with a <see cref="PoolSizeViolationException"/>
    /// <para />
    ...
    public class PoolParams
    {
        ...
        /// <summary> The maximum number of threads that may be accessing this pool.
        ///
        /// <para />Pool implementations may or may not need this to be set.
        /// </summary>
        public int MaxNumThreads { get; }

        /// <summary>
        /// Set up pool params
        /// <param name="maxSize">Soft-cap and hard-cap on size of the pool</param>
        /// <param name="bucketSizes">(optional) bucket sizes and lengths for the pool</param>
        /// </summary>
        ...
        /// <summary>
        /// Set up pool params
        /// <param name="maxSizeSoftCap">Soft cap on max size of the pool</param>
        /// <param name="maxSizeHardCap">Hard cap on max size of the pool</param>
        /// <param name="bucketSizes">(optional) bucket sizes and lengths for the pool</param>
        /// </summary>
        ...
        /// <param name="maxSizeHardCap">Hard cap on max size of the pool</param>
        /// <param name="bucketSizes">(optional) bucket sizes and lengths for the pool</param>
        /// <param name="minBucketSize">Min bucket size for the pool</param>
        /// <param name="maxBucketSize">Max bucket size for the pool</param>
        /// <param name="maxNumThreads">The maximum number of threads in th epool, or -1 if the pool doesn't care</param>
        /// </summary>
        public PoolParams(
            int maxSizeSoftCap,
            int maxSizeHardCap,
